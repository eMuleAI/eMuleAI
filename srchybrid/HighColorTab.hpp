...
#if _MSC_VER>=1400
#pragma warning(push)
#pragma warning(disable:4350) // behavior change: 'std::unique_ptr<_Ty>::auto_ptr(std::unique_ptr_ref<_Ty>) noexcept' called instead of 'std::unique_ptr<_Ty>::auto_ptr(std::unique_ptr<_Ty> &) noexcept'
#endif
