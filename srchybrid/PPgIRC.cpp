...
void CPPgIRC::DoDataExchange(CDataExchange *pDX)
{
	...
	if (!m_bInitializedTreeOpts) {
		m_htiHelpChannel = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_HELPCHANNEL")), TVI_ROOT, m_bHelpChannel);
		m_htiChannelsOnConnect = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_LOADCHANNELLISTONCON")), TVI_ROOT, m_bChannelsOnConnect);
		m_htiTimeStamp = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_ADDTIMESTAMP")), TVI_ROOT, m_bTimeStamp);
		m_htiInfoMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREINFOMESSAGE")), TVI_ROOT, FALSE);
		m_htiMiscMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREMISCMESSAGE")), m_htiInfoMessage, m_bMiscMessage);
		m_htiJoinMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREJOINMESSAGE")), m_htiInfoMessage, m_bJoinMessage);
		m_htiPartMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREPARTMESSAGE")), m_htiInfoMessage, m_bPartMessage);
		m_htiQuitMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREQUITMESSAGE")), m_htiInfoMessage, m_bQuitMessage);
		m_htiPingPongMessage = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_IGNOREPINGPONGMESSAGE")), m_htiInfoMessage, m_bPingPongMessage);
		thePrefs.m_bIRCIgnorePingPongMessages = m_bPingPongMessage;
		m_htiEmuleProto = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_EMULEPROTO_IGNOREINFOMESSAGE")), TVI_ROOT, FALSE);
		m_htiEmuleAddFriend = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_EMULEPROTO_IGNOREADDFRIEND")), m_htiEmuleProto, m_bEmuleAddFriend);
		m_htiEmuleSendLink = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_EMULEPROTO_IGNORESENDLINK")), m_htiEmuleProto, m_bEmuleSendLink);
		m_htiEmuleAllowAddFriend = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_EMULEPROTO_ALLOWADDFRIEND")), TVI_ROOT, m_bEmuleAllowAddFriend);
		m_htiAcceptLinks = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_ACCEPTLINKS")), TVI_ROOT, m_bAcceptLinks);
		m_htiAcceptLinksFriends = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_ACCEPTLINKSFRIENDS")), TVI_ROOT, m_bIRCAcceptLinksFriendsOnly);
		m_htiSmileys = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("SHOWSMILEYS")), TVI_ROOT, m_bIRCEnableSmileys);
		m_htiSoundEvents = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_SOUNDEVENTS")), TVI_ROOT, m_bSoundEvents);
		m_htiUTF8 = m_ctrlTreeOptions.InsertCheckBox(GetResString(_T("IRC_ENABLEUTF8")), TVI_ROOT, m_bIRCEnableUTF8);
...
void CPPgIRC::LocalizeItemText(HTREEITEM item, LPCTSTR strid)
{
	if (item)
...
void CPPgIRC::Localize()
{
	if (m_hWnd) {
		...
		LocalizeItemText(m_htiSoundEvents, _T("IRC_SOUNDEVENTS"));
		LocalizeItemText(m_htiTimeStamp, _T("IRC_ADDTIMESTAMP"));
		LocalizeItemText(m_htiInfoMessage, _T("IRC_IGNOREINFOMESSAGE"));
		LocalizeItemText(m_htiMiscMessage, _T("IRC_IGNOREMISCMESSAGE"));
		LocalizeItemText(m_htiJoinMessage, _T("IRC_IGNOREJOINMESSAGE"));
		LocalizeItemText(m_htiPartMessage, _T("IRC_IGNOREPARTMESSAGE"));
		LocalizeItemText(m_htiQuitMessage, _T("IRC_IGNOREQUITMESSAGE"));
		LocalizeItemText(m_htiPingPongMessage, _T("IRC_IGNOREPINGPONGMESSAGE"));
		LocalizeItemText(m_htiEmuleProto, _T("IRC_EMULEPROTO_IGNOREINFOMESSAGE"));
		LocalizeItemText(m_htiEmuleAddFriend, _T("IRC_EMULEPROTO_IGNOREADDFRIEND"));
		LocalizeItemText(m_htiEmuleAllowAddFriend, _T("IRC_EMULEPROTO_ALLOWADDFRIEND"));
		LocalizeItemText(m_htiEmuleSendLink, _T("IRC_EMULEPROTO_IGNORESENDLINK"));
		LocalizeItemText(m_htiAcceptLinks, _T("IRC_ACCEPTLINKS"));
		LocalizeItemText(m_htiAcceptLinksFriends, _T("IRC_ACCEPTLINKSFRIENDS"));
