...
BOOL CCommentDialogLst::OnInitDialog()
{
	...
	AddOrReplaceAnchor(this, IDC_EDITCOMMENTFILTER, BOTTOM_LEFT);
...
{
	InputBox inputbox;
	inputbox.SetLabels(GetResString(_T("EDITSPAMFILTERCOMMENTS")), GetResString(_T("FILTERCOMMENTSLABEL")), thePrefs.GetCommentFilter());
	inputbox.DoModal();
