...
enum ESpecialDirectoryItems
{
	...
	SDI_ED2KFILETYPE,		// SharedView Ed2kType
	SDI_DUP,				// "Duplicate Files" node
	SDI_ALLHISTORY,			// "All Downloaded History" node
...
public:
	...
	CDirectoryItem* GetSelectedFilterParent() const;
	CDirectoryItem* pHistory;
