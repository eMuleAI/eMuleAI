...
BOOL CConnectionWizardDlg::OnInitDialog()
{
	...
	m_provider.SetItemText(0, 1, EMPTY);
	m_provider.SetItemText(0, 2, EMPTY);
	m_provider.InsertItem(1, GetResString(_T("WIZARD_CUSTOM")));
	m_provider.SetItemText(1, 1, GetResString(_T("WIZARD_ENTERBELOW")));
	m_provider.SetItemText(1, 2, GetResString(_T("WIZARD_ENTERBELOW")));
...
{
	SetWindowText(GetResString(_T("WIZARD")));
	SetDlgItemText(IDC_WIZ_OS_FRAME, GetResString(_T("WIZ_OS_FRAME")));
	SetDlgItemText(IDC_WIZ_CONCURENTDOWN_FRAME, GetResString(_T("CONCURDWL")));
	SetDlgItemText(IDC_WIZ_HOTBUTTON_FRAME, GetResString(_T("WIZ_CTFRAME")));
	SetDlgItemText(IDC_WIZ_TRUEUPLOAD_TEXT, GetResString(_T("WIZ_TRUEUPLOAD_TEXT")));
	SetDlgItemText(IDC_WIZ_TRUEDOWNLOAD_TEXT, GetResString(_T("WIZ_TRUEDOWNLOAD_TEXT")));
	SetDlgItemText(IDC_KBITS, GetResString(_T("KBITSSEC")));
	SetDlgItemText(IDC_KBYTES, GetResString(_T("KBYTESSEC")));
	SetDlgItemText(IDC_WIZ_APPLY_BUTTON, GetResString(_T("PW_APPLY")));
	SetDlgItemText(IDC_WIZ_CANCEL_BUTTON, GetResString(_T("CANCEL")));
}
