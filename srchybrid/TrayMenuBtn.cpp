...
void CTrayMenuBtn::OnPaint()
{
	...
	if (IsDarkModeEnabled())
		::FillRect(MemDC.m_hDC, rClient, bClr ? CDarkMode::m_brActiveCaption : CDarkMode::m_brDefault);
	else
		::FillRect(MemDC.m_hDC, rClient, ::GetSysColorBrush(bClr ? COLOR_HIGHLIGHT : COLOR_BTNFACE));
	MemDC.SetTextColor(GetCustomSysColor(bClr ? COLOR_HIGHLIGHTTEXT : COLOR_BTNTEXT));
