...
enum ENatTraversalProtocolMode
{
	NAT_TRAVERSAL_PROTOCOL_PREFER_QUIC = 0,
...
class CPreferences
{
	...
	static LPCSTR	m_pszP2PBindAddrA;
	static LPCWSTR	m_pszP2PBindAddrW;
	static void		NormalizeRandomPortRange();
	static void		MovePreferences(EDefaultDirectory eSrc, LPCTSTR const sFile, const CString &dst);
public:
	enum
	{
		DEFAULT_RANDOM_PORT_RANGE_START = 4096,
		DEFAULT_RANDOM_PORT_RANGE_END = 65095
	};
	...
	static CStringA m_strP2PBindAddrA;
	static CStringW m_strP2PBindAddrW;
	static CString	m_strBindInterfaceId;
	static CString	m_strBindInterfaceName;
	static CString	m_strConfiguredBindAddr;
	static CString	m_strActiveBindInterfaceId;
	static CString	m_strActiveBindInterfaceName;
	static CString	m_strActiveConfiguredBindAddr;
	static ENetBindResolveResult m_eActiveBindResolveResult;
	static DWORD	m_dwActiveBindIpv4IfIndex;
	static DWORD	m_dwActiveBindIpv6IfIndex;
	static CAddress::EAF m_eActiveBindResolvedFamily;
	static EIpGuardMode m_eIpGuardMode;
	static CString	m_strIpGuardAllowedPublicIpRanges;
	static bool		m_bVpnGuardEnabled;
	static CString	m_strVpnGuardCountryCode;
	static bool		m_bVpnGuardBlockUnknownCountry;
	static bool		m_bRandomizePortsOnStartup;
	static uint16	m_nRandomPortRangeStart;
	static uint16	m_nRandomPortRangeEnd;
	static bool		m_bOpenListenPortsInWindowsFirewall;
	static uint16	port;
	static uint16	m_nConfiguredPort;
	static bool		m_bConfiguredPortAutoGenerated;
	static uint16	m_nStartupTcpPortOverride;
	static uint16	udpport;
	static uint16	m_nConfiguredUDPPort;
	static bool		m_bConfiguredUDPPortAutoGenerated;
	...
	static uint32	m_dwEServerDiscoveredExternalUdpPortPublicIP;
	static uint32	m_dwEServerDiscoveredExternalUdpPortServerIP;
	static uint16	m_nEServerDiscoveredExternalUdpPortServerPort;
	static uint32	m_dwEServerDiscoveredExternalUdpPortBuddyIP;
	...
	static bool		m_bLogUiResponsivenessEvents;
	...
	static BOOL		m_bIsDwmCompositionEnabled;
	...
	static LPCSTR	GetP2PBindAddrA() { return m_pszP2PBindAddrA; }
	static LPCWSTR	GetP2PBindAddrW() { return m_pszP2PBindAddrW; }
#ifdef UNICODE
#define GetBindAddr  GetBindAddrW
#define GetP2PBindAddr  GetP2PBindAddrW
#else
#define GetBindAddr  GetBindAddrA
#define GetP2PBindAddr  GetP2PBindAddrA
#endif // !UNICODE

	static const CString& GetBindInterfaceId() { return m_strBindInterfaceId; }
	...
	static const CString& GetActiveBindInterfaceId() { return m_strActiveBindInterfaceId; }
	...
	static ENetBindResolveResult GetActiveBindResolveResult() { return m_eActiveBindResolveResult; }
	static DWORD GetActiveBindIpv4IfIndex() { return m_dwActiveBindIpv4IfIndex; }
	static DWORD GetActiveBindIpv6IfIndex() { return m_dwActiveBindIpv6IfIndex; }
	static CAddress::EAF GetActiveBindResolvedFamily() { return m_eActiveBindResolvedFamily; }
	static EIpGuardMode GetIpGuardMode() { return m_eIpGuardMode; }
	static bool IsIpGuardEnabled() { return m_eIpGuardMode == IpGuardModeBlock; }
	static void SetIpGuardMode(EIpGuardMode eMode) { m_eIpGuardMode = eMode; }
	static const CString& GetIpGuardAllowedPublicIpRanges() { return m_strIpGuardAllowedPublicIpRanges; }
	static void SetIpGuardAllowedPublicIpRanges(const CString& strRanges) { m_strIpGuardAllowedPublicIpRanges = strRanges; m_strIpGuardAllowedPublicIpRanges.Trim(); }
	static bool IsVpnGuardEnabled() { return m_bVpnGuardEnabled; }
	static void SetVpnGuardEnabled(bool bEnabled) { m_bVpnGuardEnabled = bEnabled; }
	static const CString& GetVpnGuardCountryCode() { return m_strVpnGuardCountryCode; }
	static void SetVpnGuardCountryCode(const CString& strCountryCode) { m_strVpnGuardCountryCode = strCountryCode; m_strVpnGuardCountryCode.Trim(); m_strVpnGuardCountryCode.MakeUpper(); }
	static bool IsVpnGuardBlockUnknownCountryEnabled() { return m_bVpnGuardBlockUnknownCountry; }
	static void SetVpnGuardBlockUnknownCountry(bool bEnabled) { m_bVpnGuardBlockUnknownCountry = bEnabled; }
	static bool HasExplicitBindSelection() { return CNetBind::HasExplicitSelection(m_strBindInterfaceId, m_strBindInterfaceName, m_strConfiguredBindAddr); }
	static bool HasExplicitBindAddress() { return !m_strConfiguredBindAddr.IsEmpty(); }
	static bool RefreshBindResolution();
	static void SetBindSelection(const CString& strInterfaceId, const CString& strInterfaceName, const CString& strAddress);
	...
	static uint16 GetDefaultRandomPortRangeStart() { return static_cast<uint16>(DEFAULT_RANDOM_PORT_RANGE_START); }
	static uint16 GetDefaultRandomPortRangeEnd() { return static_cast<uint16>(DEFAULT_RANDOM_PORT_RANGE_END); }
	static bool IsValidRandomPortRange(UINT nStart, UINT nEnd);
	static uint16 GetRandomPortRangeStart() { return m_nRandomPortRangeStart; }
	static uint16 GetRandomPortRangeEnd() { return m_nRandomPortRangeEnd; }
	static void SetRandomPortRange(UINT nStart, UINT nEnd);
	static bool IsOpenListenPortsInWindowsFirewallEnabled() { return m_bOpenListenPortsInWindowsFirewall; }
	static void SetOpenListenPortsInWindowsFirewallEnabled(bool bEnabled) { m_bOpenListenPortsInWindowsFirewall = bEnabled; }
	static bool CanApplyRuntimePortRebind() { return !HasExplicitBindSelection() && !IsIpGuardEnabled() && !IsOpenListenPortsInWindowsFirewallEnabled(); }

	static uint16	GetPort() { return port; }
	static uint16	GetConfiguredPort() { return m_nConfiguredPort; }
	static void		SetConfiguredPort(uint16 nPort) { m_nConfiguredPort = nPort; m_bConfiguredPortAutoGenerated = false; }
	static bool		IsConfiguredPortAutoGenerated() { return m_bConfiguredPortAutoGenerated; }
	static void		AcceptAutoGeneratedPort(uint16 nPort) { if (m_bConfiguredPortAutoGenerated) m_nConfiguredPort = nPort; }
	...
	static uint16	GetConfiguredUDPPort() { return m_nConfiguredUDPPort; }
	static void		SetConfiguredUDPPort(uint16 nPort) { m_nConfiguredUDPPort = nPort; m_bConfiguredUDPPortAutoGenerated = false; }
	static bool		IsConfiguredUDPPortAutoGenerated() { return m_bConfiguredUDPPortAutoGenerated; }
	static void		AcceptAutoGeneratedUDPPort(uint16 nPort) { if (m_bConfiguredUDPPortAutoGenerated) m_nConfiguredUDPPort = nPort; }
	...
	static bool		m_bIPGeolocationShowFlag;
	static bool		GetIPGeolocationShowFlag() { return m_bIPGeolocationShowFlag; }
	static void		SetIPGeolocationShowFlag(bool in) { m_bIPGeolocationShowFlag = in; }
	static int		m_iIPGeolocationMode;
	static int		GetIPGeolocationMode() { return m_iIPGeolocationMode; }
	static void		SetIPGeolocationMode(int in) { m_iIPGeolocationMode = in; }
	static bool		m_bAutoIPGeolocationUpdate;
	static bool		GetAutoIPGeolocationUpdate() { return m_bAutoIPGeolocationUpdate; }
	static void		SetAutoIPGeolocationUpdate(bool in) { m_bAutoIPGeolocationUpdate = in; }
	static int		m_nIPGeolocationUpdatePeriodDays;
	static int		GetIPGeolocationUpdatePeriodDays() { return m_nIPGeolocationUpdatePeriodDays; }
	static void		SetIPGeolocationUpdatePeriodDays(int in) { m_nIPGeolocationUpdatePeriodDays = max(1, min(in, 365)); }
	static time_t	m_tLastIPGeolocationUpdate;
	static time_t	GetLastIPGeolocationUpdate() { return m_tLastIPGeolocationUpdate; }
	static void		SetLastIPGeolocationUpdate(time_t in) { m_tLastIPGeolocationUpdate = in; }
	static CString	m_strIPGeolocationUpdateURL;
	static const CString& GetIPGeolocationUpdateURL() { return m_strIPGeolocationUpdateURL; }
	static void		SetIPGeolocationUpdateURL(const CString& in) { m_strIPGeolocationUpdateURL = in; }
	...
	static int		m_iNatTraversalProtocolMode;
	static bool		IsEnableNatTraversal() { return m_bEnableNatTraversal; }
	static ENatTraversalProtocolMode GetNatTraversalProtocolMode() { return (ENatTraversalProtocolMode)m_iNatTraversalProtocolMode; }
	static void		SetNatTraversalProtocolMode(int in) { m_iNatTraversalProtocolMode = (in == NAT_TRAVERSAL_PROTOCOL_UTP_ONLY) ? NAT_TRAVERSAL_PROTOCOL_UTP_ONLY : NAT_TRAVERSAL_PROTOCOL_PREFER_QUIC; }
	static bool		IsNatTraversalQuicAllowed() { return GetNatTraversalProtocolMode() != NAT_TRAVERSAL_PROTOCOL_UTP_ONLY; }
	static bool		IsNatTraversalUtpAllowed() { return true; }
	...
	static int		m_iDownloadValidator;
	static int		m_iDownloadValidatorAcceptPercentage;
	static bool		m_bDownloadValidatorRejectCanceled;
	static bool 	m_bDownloadValidatorRejectSameHash;
	static bool		m_bDownloadValidatorRejectBlacklisted;
	static bool		m_bDownloadValidatorCaseInsensitive;
	static bool		m_bDownloadValidatorIgnoreExtension;
	...
	static bool		m_bDownloadValidatorAutoMarkAsBlacklisted;
	static bool		m_bDownloadValidatorDateTimeMatching;
	static bool		m_bDownloadValidatorDateTimeUseYearRange;
	static int		m_iDownloadValidatorDateTimeYearStart;
	...
	static void		SetDownloadValidatorAcceptPercentage(int in) { m_iDownloadValidatorAcceptPercentage = in; }
	static bool		GetDownloadValidatorRejectCanceled() { return m_bDownloadValidatorRejectCanceled; }
	static void		SetDownloadValidatorRejectCanceled(bool in) { m_bDownloadValidatorRejectCanceled = in; }
	static bool		GetDownloadValidatorRejectSameHash() { return m_bDownloadValidatorRejectSameHash; }
	static void		SetDownloadValidatorRejectSameHash(bool in) { m_bDownloadValidatorRejectSameHash = in; }
	static bool		GetDownloadValidatorRejectBlacklisted() { return m_bDownloadValidatorRejectBlacklisted; }
	static void		SetDownloadValidatorRejectBlacklisted(bool in) { m_bDownloadValidatorRejectBlacklisted = in; }
	static bool		GetDownloadValidatorCaseInsensitive() { return m_bDownloadValidatorCaseInsensitive; }
	static void		SetDownloadValidatorCaseInsensitive(bool in) { m_bDownloadValidatorCaseInsensitive = in; }
	static bool		GetDownloadValidatorIgnoreExtension() { return m_bDownloadValidatorIgnoreExtension; }
	static void		SetDownloadValidatorIgnoreExtension(bool in) { m_bDownloadValidatorIgnoreExtension = in; }
	static bool		GetDownloadValidatorIgnoreTags() { return m_bDownloadValidatorIgnoreTags; }
	static void		SetDownloadValidatorIgnoreTags(bool in) { m_bDownloadValidatorIgnoreTags = in; }
	static bool		GetDownloadValidatorDontIgnoreNumericTags() { return m_bDownloadValidatorDontIgnoreNumericTags; }
	...
	static void		SetDownloadValidatorSkipIncompleteFileConfirmation(bool in) { m_bDownloadValidatorSkipIncompleteFileConfirmation = in; }
	static bool		GetDownloadValidatorMarkAsBlacklisted() { return m_bDownloadValidatorMarkAsBlacklisted; }
	static void		SetDownloadValidatorMarkAsBlacklisted(bool in) { m_bDownloadValidatorMarkAsBlacklisted = in; }
	static bool		GetDownloadValidatorAutoMarkAsBlacklisted() { return m_bDownloadValidatorAutoMarkAsBlacklisted; }
	static void		SetDownloadValidatorAutoMarkAsBlacklisted(bool in) { m_bDownloadValidatorAutoMarkAsBlacklisted = in; }
	static bool		GetDownloadValidatorDateTimeMatching() { return m_bDownloadValidatorDateTimeMatching; }
	static void		SetDownloadValidatorDateTimeMatching(bool in) { m_bDownloadValidatorDateTimeMatching = in; }
	static bool		GetDownloadValidatorDateTimeUseYearRange() { return m_bDownloadValidatorDateTimeUseYearRange; }
	static void		SetDownloadValidatorDateTimeUseYearRange(bool in) { m_bDownloadValidatorDateTimeUseYearRange = in; }
	static int		GetDownloadValidatorDateTimeYearStart() { return m_iDownloadValidatorDateTimeYearStart; }
	static void		SetDownloadValidatorDateTimeYearStart(int in) { m_iDownloadValidatorDateTimeYearStart = in; }
	static int		GetDownloadValidatorDateTimeYearEnd() { return m_iDownloadValidatorDateTimeYearEnd; }
	static void		SetDownloadValidatorDateTimeYearEnd(int in) { m_iDownloadValidatorDateTimeYearEnd = in; }
	static bool		GetDownloadValidatorDateTimeCheckSeconds() { return m_bDownloadValidatorDateTimeCheckSeconds; }
	...
	static bool		m_bDownloadInspectorAutoRenameToMajorityNameForNewDownloadsOnly;
	static int		m_iDownloadInspectorAutoRenameToMajorityNameRequiredPercent;
	static int		m_iDownloadInspectorAutoRenameToMajorityNameMinimumVotes;
	...
	static bool		IsDownloadInspectorAutoRenameToMajorityNameForNewDownloadsOnly() { return m_bDownloadInspectorAutoRenameToMajorityNameForNewDownloadsOnly; }
	static void		SetDownloadInspectorAutoRenameToMajorityNameForNewDownloadsOnly(bool in) { m_bDownloadInspectorAutoRenameToMajorityNameForNewDownloadsOnly = in; }
	static int		GetDownloadInspectorAutoRenameToMajorityNameRequiredPercent() { return m_iDownloadInspectorAutoRenameToMajorityNameRequiredPercent; }
	static int		GetMinDownloadInspectorAutoRenameToMajorityNameRequiredPercent() { return 1; }
	static int		GetMaxDownloadInspectorAutoRenameToMajorityNameRequiredPercent() { return 100; }
	static int		GetDefaultDownloadInspectorAutoRenameToMajorityNameRequiredPercent() { return 51; }
	static void		SetDownloadInspectorAutoRenameToMajorityNameRequiredPercent(int in) { m_iDownloadInspectorAutoRenameToMajorityNameRequiredPercent = min(max(in, GetMinDownloadInspectorAutoRenameToMajorityNameRequiredPercent()), GetMaxDownloadInspectorAutoRenameToMajorityNameRequiredPercent()); }
	static int		GetDownloadInspectorAutoRenameToMajorityNameMinimumVotes() { return m_iDownloadInspectorAutoRenameToMajorityNameMinimumVotes; }
	static int		GetMaxDownloadInspectorAutoRenameToMajorityNameMinimumVotes() { return 1000; }
	static int		GetDefaultDownloadInspectorAutoRenameToMajorityNameMinimumVotes() { return 0; }
	static void		SetDownloadInspectorAutoRenameToMajorityNameMinimumVotes(int in) { m_iDownloadInspectorAutoRenameToMajorityNameMinimumVotes = min(max(in, 0), GetMaxDownloadInspectorAutoRenameToMajorityNameMinimumVotes()); }
	...
	static void		SetDownloadInspectorAutoDeleteAddedBeforeDays(int in) { m_iDownloadInspectorAutoDeleteAddedBeforeDays = in > 0 ? in : 1; }
	...
	static void		SetDownloadInspectorAutoDeleteLastSeenCompleteBeforeDays(int in) { m_iDownloadInspectorAutoDeleteLastSeenCompleteBeforeDays = in > 0 ? in : 1; }
	...
	static void		SetDownloadInspectorAutoDeleteLastReceivedBeforeDays(int in) { m_iDownloadInspectorAutoDeleteLastReceivedBeforeDays = in > 0 ? in : 1; }
	...
	static int		m_iEd2kSearchMaxResults;
	static int		m_iEd2kSearchMaxMoreRequests;
	static int		m_iKadFileSearchTotal;
	static int		m_iKadSearchKeywordTotal;
	static int		m_iKadFileSearchLifetime;
	static int		m_iKadSearchKeywordLifetime;
	static int		GetEd2kSearchMaxResults() { return m_iEd2kSearchMaxResults; }
	static void		SetEd2kSearchMaxResults(int in) { m_iEd2kSearchMaxResults = in; }
	static int		GetEd2kSearchMaxMoreRequests() { return m_iEd2kSearchMaxMoreRequests; }
	static void		SetEd2kSearchMaxMoreRequests(int in) { m_iEd2kSearchMaxMoreRequests = in; }
	static int		GetKadFileSearchTotal() { return m_iKadFileSearchTotal; }
	static void		SetKadFileSearchTotal(int in) { m_iKadFileSearchTotal = in; }
	...
	static int		GetKadFileSearchLifetime() { return m_iKadFileSearchLifetime; }
	static void		SetKadFileSearchLifetime(int in) { m_iKadFileSearchLifetime = in; }
	static int		GetKadSearchKeywordLifetime() { return m_iKadSearchKeywordLifetime; }
	static void		SetKadSearchKeywordLifetime(int in) { m_iKadSearchKeywordLifetime = in; }
	static int		GetMinKadSearchTotal() { return 100; }
	static int		GetMaxKadSearchTotal() { return 5000; }
	static int		GetMinKadSearchLifetime() { return 30; }
	static int		GetMaxKadSearchLifetime() { return 180; }
	static int		GetDefaultEd2kSearchMaxResults() { return 0; }
	static int		GetDefaultEd2kSearchMaxMoreRequests() { return 0; }
	static int		GetDefaultKadFileSearchTotal() { return 750; }
	static int		GetDefaultKadSearchKeywordTotal() { return 1500; }
	static int		GetDefaultKadFileSearchLifetime() { return 90; }
	static int		GetDefaultKadSearchKeywordLifetime() { return 90; }
	...
	static CCriticalSection m_csBlacklistList;
	...
	static uint32	m_uHighBandwidthTargetUploadClients;
	static uint32	GetMinHighBandwidthTargetUploadClients();
	static uint32	GetMaxHighBandwidthTargetUploadClients();
	static uint32	NormalizeHighBandwidthTargetUploadClients(uint32 value);
	static uint32	GetHighBandwidthTargetUploadClients() { return m_uHighBandwidthTargetUploadClients; }
	static void		SetHighBandwidthTargetUploadClients(uint32 value);
	static uint32	m_uHighBandwidthUploadSlotElasticPercent;
	static uint32	GetMinHighBandwidthUploadSlotElasticPercent();
	static uint32	GetMaxHighBandwidthUploadSlotElasticPercent();
	static uint32	NormalizeHighBandwidthUploadSlotElasticPercent(uint32 value);
	static uint32	GetHighBandwidthUploadSlotElasticPercent() { return m_uHighBandwidthUploadSlotElasticPercent; }
	static void		SetHighBandwidthUploadSlotElasticPercent(uint32 value);
	static bool		m_bHighBandwidthUploadPolicy;
	static bool		IsHighBandwidthUploadPolicyEnabled() { return m_bHighBandwidthUploadPolicy; }
	static void		SetHighBandwidthUploadPolicy(bool on) { m_bHighBandwidthUploadPolicy = on; }
	static bool		m_bAutoHighBandwidthDownloadBuffer;
	static bool		IsAutoHighBandwidthDownloadBufferEnabled() { return m_bAutoHighBandwidthDownloadBuffer; }
	static void		SetAutoHighBandwidthDownloadBuffer(bool on) { m_bAutoHighBandwidthDownloadBuffer = on; }
	static float	m_fHighBandwidthSlowUploadThresholdFactor;
	static float	GetMinHighBandwidthSlowUploadThresholdFactor();
	static float	GetMaxHighBandwidthSlowUploadThresholdFactor();
	static float	NormalizeHighBandwidthSlowUploadThresholdFactor(float value);
	static float	GetHighBandwidthSlowUploadThresholdFactor() { return m_fHighBandwidthSlowUploadThresholdFactor; }
	static void		SetHighBandwidthSlowUploadThresholdFactor(float value);
	static UINT		m_uHighBandwidthSlowUploadGraceSeconds;
	static UINT		GetMinHighBandwidthSlowUploadGraceSeconds();
	static UINT		GetMaxHighBandwidthSlowUploadGraceSeconds();
	static UINT		NormalizeHighBandwidthSlowUploadGraceSeconds(UINT value);
	static UINT		GetHighBandwidthSlowUploadGraceSeconds() { return m_uHighBandwidthSlowUploadGraceSeconds; }
	static void		SetHighBandwidthSlowUploadGraceSeconds(UINT value);
	static UINT		m_uHighBandwidthSlowUploadWarmupSeconds;
	static UINT		GetMinHighBandwidthSlowUploadWarmupSeconds();
	static UINT		GetMaxHighBandwidthSlowUploadWarmupSeconds();
	static UINT		NormalizeHighBandwidthSlowUploadWarmupSeconds(UINT value);
	static UINT		GetHighBandwidthSlowUploadWarmupSeconds() { return m_uHighBandwidthSlowUploadWarmupSeconds; }
	static void		SetHighBandwidthSlowUploadWarmupSeconds(UINT value);
	static UINT		m_uHighBandwidthZeroUploadGraceSeconds;
	static UINT		GetMinHighBandwidthZeroUploadGraceSeconds();
	static UINT		GetMaxHighBandwidthZeroUploadGraceSeconds();
	static UINT		NormalizeHighBandwidthZeroUploadGraceSeconds(UINT value);
	static UINT		GetHighBandwidthZeroUploadGraceSeconds() { return m_uHighBandwidthZeroUploadGraceSeconds; }
	static void		SetHighBandwidthZeroUploadGraceSeconds(UINT value);
	static UINT		m_uHighBandwidthSlowUploadCooldownSeconds;
	static UINT		GetMinHighBandwidthSlowUploadCooldownSeconds();
	static UINT		GetMaxHighBandwidthSlowUploadCooldownSeconds();
	static UINT		NormalizeHighBandwidthSlowUploadCooldownSeconds(UINT value);
	static UINT		GetHighBandwidthSlowUploadCooldownSeconds() { return m_uHighBandwidthSlowUploadCooldownSeconds; }
	static void		SetHighBandwidthSlowUploadCooldownSeconds(UINT value);
	static bool		m_bLowRatioQueueScoreBoost;
	static bool		IsLowRatioQueueScoreBoostEnabled() { return m_bLowRatioQueueScoreBoost; }
	static void		SetLowRatioQueueScoreBoost(bool on) { m_bLowRatioQueueScoreBoost = on; }
	static float	m_fLowRatioQueueScoreThreshold;
	static float	GetMinLowRatioQueueScoreThreshold();
	static float	GetMaxLowRatioQueueScoreThreshold();
	static float	NormalizeLowRatioQueueScoreThreshold(float value);
	static float	GetLowRatioQueueScoreThreshold() { return m_fLowRatioQueueScoreThreshold; }
	static void		SetLowRatioQueueScoreThreshold(float value);
	static UINT		m_uLowRatioQueueScoreBonus;
	static UINT		GetMinLowRatioQueueScoreBonus();
	static UINT		GetMaxLowRatioQueueScoreBonus();
	static UINT		NormalizeLowRatioQueueScoreBonus(UINT value);
	static UINT		GetLowRatioQueueScoreBonus() { return m_uLowRatioQueueScoreBonus; }
	static void		SetLowRatioQueueScoreBonus(UINT value);
	static ESessionTransferLimitMode m_eUploadSessionTransferLimitMode;
	static ESessionTransferLimitMode GetUploadSessionTransferLimitMode() { return m_eUploadSessionTransferLimitMode; }
	static ESessionTransferLimitMode NormalizeUploadSessionTransferLimitMode(ESessionTransferLimitMode mode);
	static void		SetUploadSessionTransferLimitMode(ESessionTransferLimitMode mode);
	static UINT		m_uUploadSessionTransferLimitPercent;
	static UINT		GetMinUploadSessionTransferLimitPercent();
	static UINT		GetMaxUploadSessionTransferLimitPercent();
	static UINT		NormalizeUploadSessionTransferLimitPercent(UINT value);
	static UINT		GetUploadSessionTransferLimitPercent() { return m_uUploadSessionTransferLimitPercent; }
	static void		SetUploadSessionTransferLimitPercent(UINT value);
	static UINT		m_uUploadSessionTransferLimitMiB;
	static UINT		GetMinUploadSessionTransferLimitMiB();
	static UINT		GetMaxUploadSessionTransferLimitMiB();
	static UINT		NormalizeUploadSessionTransferLimitMiB(UINT value);
	static UINT		GetUploadSessionTransferLimitMiB() { return m_uUploadSessionTransferLimitMiB; }
	static void		SetUploadSessionTransferLimitMiB(UINT value);
	static UINT		m_uUploadSessionTimeLimitSeconds;
	static UINT		GetMinUploadSessionTimeLimitSeconds();
	static UINT		GetMaxUploadSessionTimeLimitSeconds();
	static UINT		NormalizeUploadSessionTimeLimitSeconds(UINT value);
	static UINT		GetUploadSessionTimeLimitSeconds() { return m_uUploadSessionTimeLimitSeconds; }
	static void		SetUploadSessionTimeLimitSeconds(UINT value);
	...
	static bool		m_bDetectUploadRequestAbuse;
	static bool		m_bDetectUploadRequestAbuseNoRequestSlots;
	static bool		m_bDetectUploadRequestAbuseQueueDrops;
	static bool		m_bUploadRequestAbuseCounterGuard;
	static bool		m_bUploadRequestAbuseHashRotationTracking;
	static bool		m_bUploadRequestAbusePostHelloDisconnect;
	static uint8	m_uUploadRequestAbusePunishment;
	...
	static bool		IsDetectUploadRequestAbuse() { return m_bDetectUploadRequestAbuse; }
	static bool		IsDetectUploadRequestAbuseNoRequestSlots() { return m_bDetectUploadRequestAbuseNoRequestSlots; }
	static bool		IsDetectUploadRequestAbuseQueueDrops() { return m_bDetectUploadRequestAbuseQueueDrops; }
	static bool		IsUploadRequestAbuseCounterGuard() { return m_bUploadRequestAbuseCounterGuard; }
	static bool		IsUploadRequestAbuseHashRotationTracking() { return m_bUploadRequestAbuseHashRotationTracking; }
	static bool		IsUploadRequestAbusePostHelloDisconnect() { return m_bUploadRequestAbusePostHelloDisconnect; }
	static uint8	GetUploadRequestAbusePunishment() { return m_uUploadRequestAbusePunishment; }
	...
	static void		RebuildCompiledBlacklistRules();
	static SFilenameAutoBlacklistSnapshot* CreateFilenameAutoBlacklistSnapshot();
	static void		DeleteFilenameAutoBlacklistSnapshot(SFilenameAutoBlacklistSnapshot* pSnapshot);
	static bool		IsFilenameAutoBlacklisted(const SFilenameAutoBlacklistSnapshot* pSnapshot, const CString& strFilename, CString* pstrMatchedRule = NULL);
	static bool		IsFilenameAutoBlacklisted(const CString& strFilename, CString* pstrMatchedRule = NULL);
	...
	static void		SetEServerDiscoveredExternalUdpPort(uint16 port, uint8 source, uint32 publicIP = 0, uint32 serverIP = 0, uint16 serverPort = 0, uint32 buddyIP = 0);
	static void		ClearEServerDiscoveredExternalUdpPort();
	static bool		HasValidExternalUdpPort();
	static bool		IsEServerDiscoveredExternalUdpPortContextCurrent();
	...
	static bool		GetLogUiResponsivenessEvents() { return m_bVerbose && m_bLogUiResponsivenessEvents; }
...
#define thePrefs GetPreferencesStorage()
