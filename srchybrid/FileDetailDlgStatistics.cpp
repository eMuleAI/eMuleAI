...
CFileDetailDlgStatistics::CFileDetailDlgStatistics()
	...
	, m_hRefreshTimer()
{
	m_strCaption = GetResString(_T("SF_STATISTICS"));
...
BOOL CFileDetailDlgStatistics::OnInitDialog()
{
	...
	AddOrReplaceAnchor(this, pop_bartrans, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, pop_bar2, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, pop_baraccept2, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, pop_bartrans2, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_STATISTICS_GB_TOTAL, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_STATISTICS_GB_SESSION, TOP_LEFT, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_POPULARITY_LBL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_POPULARITY_VAL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_ONQUEUE_LBL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_ONQUEUE_VAL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_UPLOADING_LBL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_UPLOADING_VAL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_POPULARITY2_LBL, TOP_RIGHT);
	AddOrReplaceAnchor(this, IDC_FS_POPULARITY2_VAL, TOP_RIGHT);
...
void CFileDetailDlgStatistics::Localize()
{
	if (!m_hWnd)
		return;
	SetTabTitle(_T("SF_STATISTICS"), this);
	...
	SetDlgItemText(IDC_FS_POPULARITY2_LBL, GetResString(_T("POPULARITY")) + _T(':'));
	SetDlgItemText(IDC_FS_ONQUEUE_LBL, GetResString(_T("ONQUEUE")) + _T(':'));
	SetDlgItemText(IDC_FS_UPLOADING_LBL, GetResString(_T("UPLOADING")) + _T(':'));
}

void CFileDetailDlgStatistics::OnSysColorChange()
{
	const DWORD clr3Dface = GetCustomSysColor(COLOR_3DFACE);
