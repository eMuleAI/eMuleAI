...
void CPPgServer::Localize()
{
	if (m_hWnd) {
		...
		SetDlgItemText(IDC_RETRIES_LBL, GetResString(_T("PW_RETRIES")));
		SetDlgItemText(IDC_UPDATESERVERCONNECT, GetResString(_T("PW_USC")));
		SetDlgItemText(IDC_UPDATESERVERCLIENT, GetResString(_T("PW_UCC")));
		SetDlgItemText(IDC_AUTOSERVER, GetResString(_T("PW_USS")));
		SetDlgItemText(IDC_SMARTIDCHECK, GetResString(_T("SMARTLOWIDCHECK")));
		SetDlgItemText(IDC_SAFESERVERCONNECT, GetResString(_T("PW_FASTSRVCON")));
		SetDlgItemText(IDC_SCORE, GetResString(_T("PW_SCORE")));
		SetDlgItemText(IDC_MANUALSERVERHIGHPRIO, GetResString(_T("MANUALSERVERHIGHPRIO")));
		SetDlgItemText(IDC_EDITADR, GetResString(_T("EDITLIST")));
		SetDlgItemText(IDC_AUTOCONNECTSTATICONLY, GetResString(_T("PW_AUTOCONNECTSTATICONLY")));
	}
}
