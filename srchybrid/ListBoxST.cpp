...
void CListBoxST::DrawItem(LPDRAWITEMSTRUCT lpDIStruct)
{
	...
	COLORREF crNormal = GetCustomSysColor(COLOR_WINDOW);
	COLORREF crSelected = GetCustomSysColor(COLOR_HIGHLIGHT);
	COLORREF crText = GetCustomSysColor(COLOR_WINDOWTEXT);
