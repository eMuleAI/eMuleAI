...
{
public:
	CCBBRecord(uint64 nStartPos = 0, uint64 nEndPos = 0, CAddress IP = CAddress(), EBBRStatus BBRStatus = BBR_NONE);

	bool	Merge(uint64 nStartPos, uint64 nEndPos, CAddress IP, EBBRStatus BBRStatus = BBR_NONE);
	bool	CanMerge(uint64 nStartPos, uint64 nEndPos, CAddress IP, EBBRStatus BBRStatus = BBR_NONE) const;
