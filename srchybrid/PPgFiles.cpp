...
void CPPgFiles::Localize()
{
	if (m_hWnd) {
		...
		SetDlgItemText(IDC_DAP, GetResString(_T("PW_DAP")));
		SetDlgItemText(IDC_PREVIEWPRIO, GetResString(_T("DOWNLOADMOVIECHUNKS")));
		SetDlgItemText(IDC_ADDNEWFILESPAUSED, GetResString(_T("ADDNEWFILESPAUSED")));
		SetDlgItemText(IDC_WATCHCB, GetResString(_T("PF_WATCHCB")));
		SetDlgItemText(IDC_FULLCHUNKTRANS, GetResString(_T("FULLCHUNKTRANS")));
		SetDlgItemText(IDC_STARTNEXTFILE, GetResString(_T("STARTNEXTFILE")));
		SetDlgItemText(IDC_STARTNEXTFILECAT, GetResString(_T("PREF_STARTNEXTFILECAT")));
		SetDlgItemText(IDC_STARTNEXTFILECAT2, GetResString(_T("PREF_STARTNEXTFILECATONLY")));
		SetDlgItemText(IDC_FNC, GetResString(_T("EDIT")));
		SetDlgItemText(IDC_ONND, GetResString(_T("ONNEWDOWNLOAD")));
		SetDlgItemText(IDC_FNCLEANUP, GetResString(_T("AUTOCLEANUPFN")));
		SetDlgItemText(IDC_STATICVIDEOPLAYER, GetResString(_T("PW_VIDEOPLAYER")));
		SetDlgItemText(IDC_VIDEOPLAYER_CMD_LBL, GetResString(_T("COMMAND")));
		SetDlgItemText(IDC_VIDEOPLAYER_ARGS_LBL, GetResString(_T("ARGUMENTS")));
		SetDlgItemText(IDC_VIDEOBACKUP, GetResString(_T("VIDEOBACKUP")));
		SetDlgItemText(IDC_REMEMBERDOWNLOADED, GetResString(_T("PW_REMEMBERDOWNLOADED")));
		SetDlgItemText(IDC_REMEMBERCANCELLED, GetResString(_T("PW_REMEMBERCANCELLED")));
	}
}
...
{
	InputBox inputbox;
	inputbox.SetLabels(GetResString(_T("FNFILTERTITLE")), GetResString(_T("FILTERFILENAMEWORD")), thePrefs.GetFilenameCleanups());
	inputbox.DoModal();
