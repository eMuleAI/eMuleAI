...
TEMPLATE void CDialogMinTrayBtn<BASE>::MinTrayBtnDraw()
{
	...
	if (IsWindowsClassicStyle()) {
		COLORREF black(GetCustomSysColor(COLOR_BTNTEXT));
		COLORREF gray(GetCustomSysColor(COLOR_GRAYTEXT));
		COLORREF gray2(GetCustomSysColor(COLOR_BTNHILIGHT));
...
TEMPLATE void CDialogMinTrayBtn<BASE>::MinTrayBtnInitBitmap()
{
