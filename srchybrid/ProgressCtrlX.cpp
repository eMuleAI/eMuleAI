...
CProgressCtrlX::CProgressCtrlX()
	: /*m_pbrBar()
	, m_pbrBk()
	,*/ m_clrBk(GetCustomSysColor(COLOR_3DFACE))
	, m_clrTextOnBar(GetCustomSysColor(COLOR_CAPTIONTEXT))
	, m_clrTextOnBk(GetCustomSysColor(COLOR_BTNTEXT))
	, m_nTail()
	, m_nTailSize(40)
	...
	, m_bEmpty()
{
	...
	clrStart = clrEnd = GetCustomSysColor(COLOR_ACTIVECAPTION);
