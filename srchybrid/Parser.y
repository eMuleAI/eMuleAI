...
action			: and_searchexpr TOK_EOF
				...
				| and_searchexpr error
					{
						yyerror(GetResString(_T("IDS_SEARCH_GENERALERROR")));
						delete $1;
						return 1;
					}
				;
...
searchexpr		: attribute
				...
				| searchexpr TOK_AND error
					{
						yyerror(GetResString(_T("IDS_SEARCH_MISSINGANDRIGHT")));
						delete $1;
						return 1;
					}
				| searchexpr TOK_OR error
					{
						yyerror(GetResString(_T("IDS_SEARCH_MISSINGORRIGHT")));
						delete $1;
						return 1;
					}
				| searchexpr TOK_NOT error
					{
						yyerror(GetResString(_T("IDS_SEARCH_MISSINGNOTRIGHT")));
						delete $1;
						return 1;
					}
				| '(' error
					{
						yyerror(GetResString(_T("IDS_SEARCH_MISSINGEXPRPARANT")));
						return 1;
					}
				| '(' and_searchexpr error
					{
						yyerror(GetResString(_T("IDS_SEARCH_MISSINGCLOSINGPARANT")));
						delete $2;
						return 1;
					}
				;
...
attribute		: TOK_STRING
				...
				| int_opr
					{ yyerrorf(GetResString(_T("IDS_SEARCH_OPRERR")), DbgGetSearchOperatorName($1)); return 1; }

				| TOK_SIZE int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@size")); return 1; }
				| TOK_SIZE error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@size")); return 1; }

				| TOK_TYPE TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@type")); return 1; }
				| TOK_TYPE error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@type")); return 1; }

				| TOK_EXT TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@ext")); return 1; }
				| TOK_EXT error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@ext")); return 1; }

				| TOK_SOURCES int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@sources")); return 1; }
				| TOK_SOURCES error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@sources")); return 1; }

				| TOK_COMPLETE int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@complete")); return 1; }
				| TOK_COMPLETE error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@complete")); return 1; }

				| TOK_RATING int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@rating")); return 1; }
				| TOK_RATING error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@rating")); return 1; }

				| TOK_BITRATE int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@bitrate")); return 1; }
				| TOK_BITRATE error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@bitrate")); return 1; }

				| TOK_LENGTH int_opr error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@length")); return 1; }
				| TOK_LENGTH error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@length")); return 1; }

				| TOK_CODEC TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@codec")); return 1; }
				| TOK_CODEC error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@codec")); return 1; }

				| TOK_TITLE TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@title")); return 1; }
				| TOK_TITLE error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@title")); return 1; }

				| TOK_ALBUM TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@album")); return 1; }
				| TOK_ALBUM error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@album")); return 1; }

				| TOK_ARTIST TOK_OPR_EQ error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@artist")); return 1; }
				| TOK_ARTIST error
					{ yyerrorf(GetResString(_T("IDS_SEARCH_ATTRERR")), _T("@artist")); return 1; }
				;
