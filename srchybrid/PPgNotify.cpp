...
{
	if (m_hWnd) {
		SetWindowText(GetResString(_T("PW_EKDEV_OPTIONS")));
		SetDlgItemText(IDC_CB_TBN_USESOUND, GetResString(_T("PW_TBN_USESOUND")));
		SetDlgItemText(IDC_CB_TBN_NOSOUND, GetResString(_T("NOSOUND")));
		SetDlgItemText(IDC_CB_TBN_ONLOG, GetResString(_T("PW_TBN_ONLOG")));
		SetDlgItemText(IDC_CB_TBN_ONCHAT, GetResString(_T("PW_TBN_ONCHAT")));
		...
		SetDlgItemText(IDC_SMTPSERVER, GetResString(_T("SMTPSERVER")) + _T("..."));
		SetDlgItemText(IDC_TXT_RECEIVER, GetResString(_T("PW_RECEIVERADDRESS")));
		SetDlgItemText(IDC_TXT_SENDER, GetResString(_T("PW_SENDERADDRESS")));
		SetDlgItemText(IDC_CB_ENABLENOTIFICATIONS, GetResString(_T("PW_ENABLEEMAIL")));
		SetDlgItemText(IDC_TEST_NOTIFICATION, GetResString(_T("TEST")));
	}
}
...
void CPPgNotify::OnBnClickedTestNotification()
{
	...
	CString strTest;
	strTest.Format(GetResString(_T("MAIN_READY")), (LPCTSTR)theApp.GetAppVersion().Mid(6));
